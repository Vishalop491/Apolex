...
class Akinator(commands.Cog):
    ...
    async def akinator(self,ctx):
        intro=discord.Embed(title="Akinator",description="Hello, "+ctx.author.mention+"I am Akinator!!!",color=0x2f3136)
        ...
        bye=discord.Embed(title="Akinator",description="Bye, "+ctx.author.mention,color=0x2f3136)
        ...
        try:
            ...
            while aki.progression <= 80:
                question=discord.Embed(title="Question",description=q,color=0x2f3136)
                ...
                if msg.content.lower() in ["b","back"]:
                    ...
                    try:
                        ...
                        continue
            aki.win()
            answer=discord.Embed(title=aki.first_guess['name'],description=aki.first_guess['description'],color=0x2f3136)
