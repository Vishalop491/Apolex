...
class autosnipe(commands.Cog):
    ...
    async def channel(self, ctx, c: discord.TextChannel):
        try:
            ...
            await ctx.send(f"<a:nr_tick:956867762398044200>  | autosnipe channel are updated to <#{c.id}>")
    ...
    async def delete(self, ctx: commands.Context):
        ...
        await ctx.send(f'<a:nr_tick:956867762398044200> | Successfully Deleted autosnipe Channel')
